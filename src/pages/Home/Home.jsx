...
import { ContentWrapper, HomeSection, HomeTextMain, HomeTextSecondary, HomeWrapper } from "./Home.styled";
...
Життя непередбачуване і ніколи не знаєш, в яких ситуаціях може терміново знадобиться прокат автомобіля. Для вирішення даної проблеми існує сервіс компанії CarForLive – послуги автопрокату. Ми пропонуємо взяти машину в оренду на найвигідніших умовах – від 18 $ на добу.
            ...
            <HomeTextSecondary>
            In modern society, such values as time and comfort increasingly come to the fore, so a service such as car rental has ceased to be a luxury, but has become a daily necessity.

Depending on the situation, buying a car is not always an appropriate investment. For example, for guests of Kyiv for tourist or business purposes, the best solution would be daily car rental - it is inexpensive to solve temporary issues. For residents of the capital, this service will also be useful for making various types of trips around Ukraine: renting a car for a wedding, vacation, photo shoot or just for entertainment purposes.

Life is unpredictable and you never know in which situations you may urgently need a car rental. To solve this problem, there is a service of the CarForLive company - car rental services. We offer to rent a car on the most favorable terms - from $18 per day.
            </HomeTextSecondary>
          </ContentWrapper>
        </HomeWrapper>
      </HomeSection>
